...
import { enableButtons, disableButtons } from "./globalFunctions.js";
        ...
        document.querySelector('#battle').querySelector('#second-column').querySelectorAll('.wrapper-btns__btn').forEach(elem =>{
            ...
            elem.addEventListener('click', () =>{
                ...
                if(elem.classList.contains('first-weapon-button') === true){
                    ...
                    if(arrayEnemiesTraits[activeEnemyIndex][0] === 0 && arrayEnemiesTraits[activeEnemyIndex][4] === false){
        ...
        function playerAttack(){
            ...
            function damageToHealth(){
                ...
                if(enemyHealthPoints === 0){
                    ...
                    arrayEnemiesTraits[activeEnemyIndex][4] = false;

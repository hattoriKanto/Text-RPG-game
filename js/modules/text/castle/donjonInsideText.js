        ...
        english: {
            ...
            donjonFirstFloor: {
                ...
                donjonInside: {
                    ...
                    textTitle: 'Inside the donjon',
    
                    textDescr: 'It looks like the invaders are well established here. You should expect more enemies in the rooms of the donjon. You cautiously step inside, and there you are, standing in a hall that is lightly lit by candles on stands in the far corners. At the very end of the hall you can see corridors that lead in different directions. Right in front of the corridors is a statue of the Emperor-Founder, however, it`s disfigured. The head is missing, evidently the cultists don`t like him much, or they dislike all statues.',
    
                    textButton: {
    
                        firstButton: 'Come to a crossroads'
                ...
                donjonCrossroads: {
                    ...
                    textTitle: 'Crossroads',
    
                    textDescr: 'When you come to the crossroads, you have to choose which way to go. Both corridors are lit by torches, and you seem to see several doors on each path. Somewhere in the distance you can hear the same sounds you heard outside. You need to be extremely careful.',
    
                    textButton: {
    
                        firstButton: 'Go to the right',
    
                        secondButton: 'Go to the left'
                ...
                donjonAlchemistRoomTable: {
                    ...
                    textTitle: 'The alchemist`s table',
    
                    textDescr: 'On the alchemist`s desk are many notes and memos about potions, herbs, and various critters that live in the area. After reviewing a couple of papers, you find a letter stamped with the seal of the Imperial Society of the Alchemists. Based on the contents of the letter, one of the alchemist`s tasks was to study the local flora and fauna. Particular attention was to be paid to the White Kane plant or `singing flower`. A little digging in the alchemist`s notes, you came across a description of this flower: white petals on a thin green stem, and the fruit itself is blue in color. Most surprisingly, the alchemist`s notes say that the flower... "sings." You are not quite sure what that means, but there`s certainly nothing in the lab that fits the description.',
                ...
                donjonAlchemistRoomWorkplace: {
                    ...
                    textTitle: 'The alchemist`s workplace',
    
                    textDescr: 'The alchemist`s workplace is in chaos. No doubt the place was orderly before the attack, but now this place can`t be called a laboratory. Among the broken flasks and bottles you found a couple of potions.',
                ...
                donjonDoorToMageRoom: {
                    ...
                    textDescr: 'The door to the room is slightly open. Above the door is a tablet with the image of a wand. The magic wand is one of the main attributes of an imperial mage, which is the concentration of all the power of the mage. Wands are unique in their shape and structure and are highly prized on the black market. However, no one but the master can use the wand, and after the death of the mage, the wand becomes a useless piece of valuable artwork. How the wands appeared and how the people of the Empire obtained magical properties remains a classified information.',
                ...
                donjonMageRoom: {
                    ...
                    textTitle: 'The communications wizard`s room',
    
                    textDescr: 'The room is orderly and peaceful, a contrast to what is going on inside the castle walls. For some reason, the attackers ignored this place. It is unclear what happened to the mage and whether he is still alive. Perhaps we should take a look around, and then something will become clearer.',
                ...
                donjonMageRoomCommDevice: {
                    ...
                    textTitle: 'Communication device',
    
                    textDescr: 'A standard communication device in the imperial military. Developed by an anonymous mage and dwarven blacksmith over 30 years ago to replace pigeon mail. Like all military documentation, the specifications and drawings of the device are classified. The design of the device, at first glance, is very simple: a metal sphere with a through hole, which lies in the center of two metal rims. The sphere itself has various rune symbols. All this construction stands on a metal platform. This device takes up more than half of the room, and yet this little sphere seems to do most of the work. It`s not clear how it works, though.',
                ...
                donjonMageRoomTable: {
                    ...
                    textTitle: 'The magician`s table',
    
                    textDescr: 'Judging by the layer of dust on the table, no one has approached the table for a long time. There`s a log on the desk, with the dates of contact with command. The last one was a couple days ago. Maybe there`s something wrong with the communication device or maybe it`s sabotage...',
                ...
                donjonMageRoomSleepingPlace: {
                    ...
                    textDescr: 'The magician`s room is divided by a wall with a passage. When you enter the passage, you find a sleeping place: a regular bed and a small closet. The bed is in the center of the room, and the closet is in the far left corner from the entrance. After examining the sleeping area, you notice a worn floor around the bed. It looks like someone has moved the bed quite a bit. Pushing the bed aside, you discovered a small door. Opening it, you found a stash of various papers, as well as a couple potions.',
        ...
        russian: {
            ...
            donjonFirstFloor: {
                ...
                donjonInside: {
                    ...
                    textDescr: 'Похоже, что захватчики крепко обосновались тут. Следует ожидать больше врагов в помещениях донжона. Вы осторожно входите внутрь и вот, вы уже стоите в зале, который слегка освещается свечами на стойках в дальних углах. В самом конце зала видны коридоры, которые ведут в разные стороны. Прямо перед ними стоит статуя Императора-Основателя, правда, слегка изуродована. На ней отсутствует голова, видимо, культисты не особо его любят или они не жалуют все статуи.',
                ...
                donjonCrossroads: {
                    ...
                    textDescr: 'Подойдя к развилке, вам предстоит выбрать, куда идти. Оба коридора освещаются факелами, и похоже вы видите несколько дверей на каждом пути. Где-то вдалеке слышны такие же звуки, какие вы слышали снаружи. Нужно быть предельно осторожными.',
                ...
                donjonAlchemistRoomTable: {
                    ...
                    textDescr: 'На столе у алхимика лежит множество заметок и записок о зельях, травах и различной живности, которая обитает в округе. Просмотрев пару бумаг, вы обнаружили письмо с печатью Имперского общества алхимиков. Исходя из содержания письма, одной из задач алхимика было изучение местной флоры и фауны. Особое внимание следовало уделить растению Белый Кейн или "поющий цветок". Немного покопавшись в записях алхимика, вы наткнулись на описание этого цветка: белые лепестки на тонком зелёном стебле, а сам же плод - голубого цвета. Самое удивительное, что в записях алхимика написано, что цветок... "поёт". Не совсем понятно, что это значит, но в лаборатории точно нет ничего, что подходит под описание.',
                ...
                donjonAlchemistRoomWorkplace: {
                    ...
                    textDescr: 'На рабочем месте алхимика царит разруха. Без сомнений, до нападения тут царил порядок, но теперь назвать это место лабораторией язык не поворачивается. Среди разбитых колб и бутылок вы нашли парочку зелий.',
                ...
                donjonDoorToMageRoom: {
                    ...
                    textDescr: 'Дверь в комнату слегка приоткрыта. Над дверью закрепленная табличка с изображением жезла. Магический жезл - один из основных атрибутов имперского мага, который является сосредоточением всей мощи мага. Жезлы по своей форме и структуре уникальны и очень ценятся на чёрном рынке. Однако, никто кроме хозяина не может использовать жезл, а после смерти мага жезл становится бесполезным куском ценного произведения искусства. Как появились жезлы и как люди Империи получили магические свойства остаётся информацией с грифом секретно.',
                ...
                donjonMageRoom: {
                    ...
                    textDescr: 'В помещении царит порядок и покой, что контрастирует с тем, что происходит в стенах замка. По какой-то причине нападавшие проигнорировали это место. Что стало с магом и жив ли он ещё - непонятно. Возможно стоит осмотреться и тогда что-то и прояснится.',
                ...
                donjonMageRoomCommDevice: {
                    ...
                    textDescr: 'Стандартное устройство для связи в имперских военных формированиях. Разработано анонимными магом и гномом-кузнецом более 30 лет назад для замены голубиной почты. Как и вся военная документация, технические характеристики и чертежи устройства засекречены. Конструкция устройства, на первый взгляд, очень проста: металлическая сфера с сквозным отверстием, которая лежит в центре двух металлических ободов. Сама же сфера имеет различные рунные символы. Вся эта конструкция стоит на металлической платформе. Это устройство занимает более половины комнаты, и всё же, похоже эта маленькая сфера выполняет основную работу. Правда, как всё это работает не понятно.',
                ...
                donjonMageRoomTable: {
                    ...
                    textDescr: 'Судя по слою пыли на столе, к нему никто не подходил уже долгое время. На столе лежит журнал, в котором указаны даты выходя на связь с командованием. Последний выход был пару дней назад. Возможно с устройством связи что-то не так или возможно это саботаж...',
                ...
                donjonMageRoomSleepingPlace: {
                    ...
                    textDescr: 'Комната мага разделена стеной с проходом. Пройдя в проход, вы обнаружили спальное место: обычная кровать и небольшой шкаф. Кровать стоит по центру помещения, а шкаф - в дальнем левом углу от входа. После осмотра спального места, вы заметили потёртый пол вокруг кровати. Похоже, кто-то двигал кровать довольно часто. Отодвинув кровать, вы обнаружили небольшую дверцу. Открыв её, вы обнаружили тайник с различными бумагами, а также парочку зелий.',
                ...
                donjonChapel: {
                    ...
                    textButton: {
                        ...
                        firstButton: 'Осмотреть труп рыцаря',
                ...
                donjonChapelDeadKnight: {
                    ...
                    textTitle: 'Труп рыцаря',
    
                    textDescr: 'С виду ничего необычного вы не видите. Его принадлежность по доспеху определить сложно, однако, что бы позволить себе такие латы нужно быть состоятельным или иметь щедрых покровителей. Возможно, что детальный осмотр тела сможет кое что прояснить.',
    
                    textButton: {
    
                        firstButton: 'Осмотреть руки'
                ...
                donjonChapelPileOfCorpses: {
                    ...
                    textDescr: 'Когда вы вошли в комнату, то культсты бережно складывали трупы в ряд. Перед вами с десяток трупов легионеров. Зачем нападавшие сносили трупы из всего донжона сюда? Неужели они прониклись сочувствием к поверженному противнику? Это вряд ли. ',
                ...
                donjonCorridorAfterChapel: {
                    ...
                    textDescr: 'И вот снова коридор. Где-то вдалеке слышен брязг доспехов и одинокие тяжёлые шаги, от которых под вашими ногами пульсирует земля. Впереди вы видите большие двери и коридор, который поворачивает влево от часовни. Похоже, что вы можете пройти на склад следуя этим коридором. Подойдя поближе к дверям, вы замечаете ещё одни проход, за которым расположены ступеньки, которые ведут наверх.',
    
                    textButton: {

                        firstButton: 'Пройти наверх',

                        secondButton: 'Осмотреть дверь',
                ...
                donjonCorridorToWarehouse: {
                    ...
                    textDescr: 'И снова пусто, как будто бы эта часть донжона брошена или оставлена. Чем ближе вы подходите к складу, тем сильнее пульсирует земля под вашими ногами. Помимо двери на склад, в коридоре есть второй выход на крышу донжона. Похоже, что именно через него прошли культисты и тот пленник.',
                ...
                donjonDoorWarehouse: {
                    ...
                    textDescr: 'Чем ближе вы подходите к складу, тем сильнее становиться вонь, как будто бы здесь содержат скот. Большие деревянные двери с табличкой над ними и знаком "ящик". У вас уже есть ключ, который может отпереть эту дверь.',
    
                    textButton: {

                        firstButton: 'Открыть двери',
            ...
            donjonSecondFloor: {
                ...
                donjonSecondFloor: {
                    ...
                    textButton: {
                        ...
                        firstButton: 'Поговорить с пленным'
                ...
                donjonSecondFloorPrisoner: {
                    ...
                    textDescr: 'Высокий мужчина, средних лет. Если судить по знакам отличия на форме, то он состоит в офицерском корпусе. По всему телу следы побоев и открытая рана на ноге. При вашем приближении, он медленно, но уверенно встаёт на ноги опираясь на меч, который офицер поднял возле трупа чёрного рыцаря.',
                ...
                donjonPrisonerWhoAreYou: {
                    ...
                    textButton: {
                        ...
                        firstButton: 'Как всё это произошло?',
